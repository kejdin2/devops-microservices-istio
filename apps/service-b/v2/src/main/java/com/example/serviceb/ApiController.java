...
public class ApiController {
  ...
  public Map<String, Object> info() {
    return Map.of(
      ...
      "note", "v2 adds validation + different status"
    );
  }
  ...
  public Map<String, Object> handle(
    ...
    try {
      String key = "service-b:v2:count:" + session;
    ...
    resp.put("version", "v2");
    resp.put("message", "service-b V2: order accepted with NEW pipeline");
